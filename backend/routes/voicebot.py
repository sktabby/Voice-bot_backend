...
# ✅ NEW: Shared processor used by /voicebot and /stream/finalize
def process_audio_path(raw_path: str, language_code: str, session_id: str):
    ...
    if llm_reply.strip():
        if detected_lang.startswith("en"):
            ...
            llm_reply_hi, llm_reply_hi_response = translate_text(llm_reply, "en-IN", detected_lang)
...
async def voicebot(
    ...
    # ✅ Reuse shared pipeline
    return process_audio_path(raw_path, language_code, session_id)
